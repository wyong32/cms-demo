  ...
  <div class="dashboard">
    <div class="dashboard-header">
      ...
      <div class="header-actions">
        <el-button type="primary" @click="refreshAll" :loading="statsLoading || activitiesLoading">
    ...
    <!-- 统计卡片 -->
    <el-row :gutter="20" class="stats-row" v-loading="statsLoading" element-loading-text="正在加载统计数据...">
      <el-col :xs="24" :sm="12" :md="6">
        <el-card class="stats-card" :class="{ 'loading-card': statsLoading }">
          <div class="stats-item">
            <div class="stats-icon" style="background: #409eff;">
              <el-icon size="24"><Document /></el-icon>
            </div>
            <div class="stats-content">
              <div class="stats-number" :class="{ 'number-loading': statsLoading }">
    ...
    <el-row :gutter="20" class="content-row">
      <!-- 最近活动 -->
      <el-col :xs="24" :lg="12">
        <el-card class="content-card" v-loading="activitiesLoading" element-loading-text="正在加载活动记录...">
          <template #header>
            <div class="card-header">
              <h3>最近活动</h3>
              <el-button type="text" @click="refreshActivities" :loading="activitiesLoading">
                <el-icon><Refresh /></el-icon>
                刷新
              </el-button>
            </div>
